cp ~/.config/hypr/themes/togaland.conf ~/.config/hypr/hyprland.conf

cp ~/.config/waybar/themes/toga/config ~/.config/waybar/config
cp ~/.config/waybar/themes/toga/style.css ~/.config/waybar/style.css
cp ~/.config/waybar/themes/toga/colors.css ~/.config/waybar/colors.css
